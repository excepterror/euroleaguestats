...
class MenuScreenView(Screen):
    ...
    def about_animate_on_push(self, instance):
        anim = Animation(size_hint_x=.22, height=adaptive_height(dp_base=30, font_scale=App.get_running_app().font_scale), font_size=App.get_running_app().font_scale * sp(7), duration=.1)
